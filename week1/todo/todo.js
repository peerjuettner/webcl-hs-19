...
const TodoController = () => {
  const Todo = () => {
    ...
    return {
      ...
      getValid: valid.getValid,
      setValid: valid.setValid,
  ...
  const addFortuneTodo = () => {
    ...
    scheduler.add(ok =>
      fortuneService(text => {
        // todo: schedule the fortune service and proceed when done
...
const TodoOpenView = (todoController, numberOfOpenTasksElement) => {
  const render = () =>
    (numberOfOpenTasksElement.innerText =
      "" + todoController.numberOfopenTasks());
